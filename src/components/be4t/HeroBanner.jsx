...
const SLIDES = [
    {
        id: 'b2b',
        badge: 'SELLOS · DISTRIBUIDORAS · ARTISTAS',
        badgeColor: '#06b6d4',
        badgeBg: 'rgba(6,182,212,0.12)',
        badgeBorder: 'rgba(6,182,212,0.3)',
        title: 'Infraestructura de\nActivos Musicales',
        titleGradient: 'linear-gradient(135deg, #ffffff 0%, #06b6d4 60%, #a855f7 100%)',
        subtitle: 'Tokenizamos derechos de flujo de caja de catálogos musicales. Habilitamos a sellos y distribuidoras para adelantar regalías a sus artistas a través de nuestra comunidad de inversores institucionales y retail. ERC-3643 compliant · Delaware/UE ready.',
        cta: { label: 'Agendar Demo Institucional →', action: () => alert('Demo institucional: partners@be4t.com') },
        ctaStyle: 'border',
        accent: '#06b6d4',
    ...
    {
        id: 'fans',
        badge: 'INVERSORES · US · EU',
        badgeColor: '#10b981',
        badgeBg: 'rgba(16,185,129,0.1)',
        badgeBorder: 'rgba(16,185,129,0.3)',
        title: 'Diversifica en Activos\nMusicales de Alto Crecimiento',
        titleGradient: 'linear-gradient(135deg, #ffffff 0%, #10b981 55%, #06b6d4 100%)',
        subtitle: 'Rentabilidad descorrelacionada del mercado tradicional. Adquiere Derechos de Flujo de Caja (Streaming Royalties) en los activos musicales de mayor momentum. Yield Proyectado basado en datos reales de Spotify & YouTube. Pagos trimestrales automáticos vía Smart Contract.',
        cta: { label: 'Acceder al Mercado de Activos →', action: null, page: 'explore' },
        ctaStyle: 'gradient',
        accent: '#10b981',
        glow1: 'rgba(16,185,129,0.15)',
        glow2: 'rgba(6,182,212,0.10)',
        bgOverlay: 'radial-gradient(ellipse 80% 60% at 50% 80%, rgba(16,185,129,0.12) 0%, transparent 70%), radial-gradient(ellipse 50% 40% at 80% 15%, rgba(6,182,212,0.08) 0%, transparent 60%), #080812',
    },
];
